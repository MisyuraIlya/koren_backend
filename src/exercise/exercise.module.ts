...
@Module({
  imports: [TypeOrmModule.forFeature([ExerciseEntity,CourseEntity, TabEntity, TaskEntity, ColumnTaskEntity, RowTaskEntity, ObjectiveEntity, AnswerEntity, ValueEntity])],
